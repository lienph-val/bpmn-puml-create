...
ElementRegistry.prototype.find = function(fn) {
  var map3 = this._elements, keys2 = Object.keys(map3);
  for (var i = 0; i < keys2.length; i++) {
    var id = keys2[i], container = map3[id], element = container.element, gfx = container.gfx;
    if (fn(element, gfx)) {
      return element;
    }
  }
...
//# sourceMappingURL=chunk-PNFRJJFC.js.map
