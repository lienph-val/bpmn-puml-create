...
function ConnectPreview(injector, eventBus, canvas) {
  ...
  eventBus.on("connect.hover", LOW_PRIORITY3, function(event3) {
...
function AttachEventBehavior(bpmnReplace, injector) {
  ...
  var self2 = this;
  this.postExecuted("elements.create", LOW_PRIORITY4, function(context) {
    var elements = context.elements;
  ...
  this.preExecute("elements.move", LOW_PRIORITY4, function(context) {
...
function DeleteLaneBehavior(eventBus, spaceTool) {
  ...
  this.postExecuted("shape.delete", LOW_PRIORITY5, function(event3) {
...
function DetachEventBehavior(bpmnReplace, injector) {
  ...
  this._bpmnReplace = bpmnReplace;
  var self2 = this;
  this.postExecuted("elements.create", LOW_PRIORITY6, function(context) {
    var elements = context.elements;
  ...
  this.preExecute("elements.move", LOW_PRIORITY6, function(context) {
...
function getRelativeFootPosition(line, foot) {
  var length = getDistancePointPoint(line[0], line[1]), lengthToFoot = getDistancePointPoint(line[0], foot);
...
function RootElementReferenceBehavior(bpmnjs, eventBus, injector, moddleCopy, bpmnFactory) {
  ...
  eventBus.on("copyPaste.pasteElement", LOW_PRIORITY7, function(context) {
...
function SubProcessPlaneBehavior(canvas, eventBus, modeling, elementFactory, bpmnFactory, bpmnjs, elementRegistry) {
  ...
  this.executed("shape.toggleCollapse", LOW_PRIORITY8, function(context) {
    var shape = context.shape;
    if (!is(shape, "bpmn:SubProcess")) {
      return;
    }
  ...
  this.reverted("shape.toggleCollapse", LOW_PRIORITY8, function(context) {
    var shape = context.shape;
    if (!is(shape, "bpmn:SubProcess")) {
      return;
    }
...
function ToggleElementCollapseBehaviour(eventBus, elementFactory, modeling) {
  ...
  this.executed(["shape.toggleCollapse"], LOW_PRIORITY9, function(e4) {
  ...
  this.reverted(["shape.toggleCollapse"], LOW_PRIORITY9, function(e4) {
  ...
  this.postExecuted(["shape.toggleCollapse"], LOW_PRIORITY9, function(e4) {
...
function UpdateFlowNodeRefsBehavior(eventBus, modeling) {
  ...
  this.postExecuted(laneRefUpdateEvents, LOW_PRIORITY10, function(event3) {
    releaseContext();
  });
  this.preExecute([
    "shape.create",
...
function CreatePreview(canvas, eventBus, graphicsFactory, previewSupport, styles) {
  ...
  eventBus.on("create.move", LOW_PRIORITY11, function(event3) {
...
function BpmnCopyPaste(bpmnFactory, eventBus, moddleCopy) {
  ...
  eventBus.on("copyPaste.copyElement", LOW_PRIORITY12, function(context) {
...
ToolManager.prototype.bindEvents = function(name, events) {
  ...
  eventBus.on(eventsToRegister, LOW_PRIORITY13, function(event3) {
    if (!this._active) {
      return;
    }
...
function SpaceToolPreview(eventBus, elementRegistry, canvas, styles, previewSupport) {
  ...
  eventBus.on("spaceTool.move", LOW_PRIORITY14, function(event3) {
...
function LabelSupport(injector, eventBus, modeling) {
  ...
  movePreview && eventBus.on("shape.move.start", LOW_PRIORITY15, function(e4) {
...
function DistributeElementsMenuProvider(popupMenu, distributeElements, translate2, rules) {
  ...
  this._popupMenu = popupMenu;
  this._rules = rules;
  popupMenu.registerProvider("align-elements", LOW_PRIORITY17, this);
}
...
var LOW_PRIORITY18 = 800;
function GridSnapping(elementRegistry, eventBus, config) {
  var active = !config || config.active !== false;
  this._eventBus = eventBus;
  var self2 = this;
  eventBus.on("diagram.init", LOW_PRIORITY18, function() {
...
function ResizePreview(eventBus, canvas, previewSupport) {
  ...
  eventBus.on("resize.move", LOW_PRIORITY19, function(event3) {
...
function MoveEvents(eventBus, dragging, modeling, selection, rules) {
  ...
  eventBus.on("shape.move.move", LOW_PRIORITY20, function(event3) {
...
function MovePreview(eventBus, canvas, styles, previewSupport) {
  ...
  eventBus.on("shape.move.start", LOW_PRIORITY21, function(event3) {
